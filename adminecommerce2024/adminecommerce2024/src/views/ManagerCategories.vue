<template>
    <div class="container">
      ...
      <div v-if="showAddCategoryModal || showEditCategoryModal" class="modal fade show d-block">
            ...
            <div class="modal-body">
              <form @submit.prevent="saveCategory">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" v-model="categoryForm.description" required></textarea>
                </div>
                <div class="text-end">
                  <button type="submit" class="btn btn-success">{{ showEditCategoryModal ? 'Update' : 'Add' }} Category</button>
                </div>
              </form>
            </div>
          </div>
